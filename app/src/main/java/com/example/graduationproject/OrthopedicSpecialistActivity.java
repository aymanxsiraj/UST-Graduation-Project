...
public class OrthopedicSpecialistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orthopedic_specialist);
        ...
        recyclerView = findViewById(R.id.orthopedic_doctors);
        ...
        specialistAdapter = new DoctorSpecialistAdapter(this, doctorArrayList, position -> {
            ...
            Intent intent = new Intent(OrthopedicSpecialistActivity.this, BookAppointmentWithDoctorActivity.class);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                    ...
                    assert doctor!= null;
                    if(doctor.getDoctorSpecialist().equalsIgnoreCase("Orthopedic Specialist")){
